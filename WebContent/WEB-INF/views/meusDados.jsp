...
<body>
	...
	<div class="nav-wrapper indigo">
		...
		<ul class="right hide-on-med-and-down">
			<li><a href="redefinirSenha">Alterar Senha</a></li>
			<li><a
		...
		<ul class="side-nav" id="mobile-demo">
			<li><a href="redefinirSenha">Alterar Senha</a></li>
			<li><a href="conta"><i class="material-icons right red-text">fast_rewind</i>Voltar</a></li>
		</ul>
	</div>
	</nav>
		...
		<form class="col s12" action="alteraCliente" method="Post">
			...
			<div class="row">
				...
				<div class="col s12 m4">
					<div class="input-field">
						<i class="material-icons prefix grey-text text-indigo">
							location_on</i> <input disabled value="${cliente.cidade}" id="cidade"
							name="cidade" type="text" class="validate black-text"> <label
							for="cidade"><h6>
								<b>Cidade</b>
							</h6></label>
					</div>
